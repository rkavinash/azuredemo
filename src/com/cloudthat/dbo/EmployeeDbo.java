...
public class EmployeeDbo {
	...
	public EmployeeDbo()
			throws InvalidKeyException, IllegalArgumentException, RuntimeException, IOException, 
...
URISyntaxException {
		...
		} catch (StorageException | InvalidKeyException | RuntimeException | IOException | 
...
URISyntaxException e) {
	...
	public void deleteEmployee(String partitionKey, String rowKey) {
		...
		try {
			...
			// and row key
			TableOperation retrieveEmployee = TableOperation.retrieve(partitionKey, rowKey, 
...
EmployeeEntity.class);
	...
	public List<EmployeeEntity> getAllEmployee() {
		...
		for (EmployeeEntity entity : table.execute(partitionScanQuery)) {
			EmployeeEntity employee = new EmployeeEntity(entity.getPartitionKey(), 
...
entity.getRowKey());
	...
	private static CloudTable createTable(CloudTableClient tableClient, String tableName)
			throws StorageException, RuntimeException, IOException, InvalidKeyException, 
